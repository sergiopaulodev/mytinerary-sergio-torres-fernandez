...
export default function LinkLogOut( {onClick} ) {
  return (
    <>
        <button className="bg-[#756ff1] rounded-lg py-2 px-4
        hover:transition
        hover:ease-in-out
        hover:bg-[#ac3335]
        ">

            <Anchor to="/auth/logout" onClick={onClick} className="flex justify-between items-center gap-4 text-2xl text-white">
